(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_01522d._.js", {
...
(()=>{
    const e = new Error("Cannot find module 'better-auth/client/plugins'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@better-auth/passkey/client'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const authClient = baseURL ? createAuthClient({
    baseURL,
    plugins: [
        emailOTPClient(),
        passkeyClient()
...
//# sourceMappingURL=src_01522d._.js.map