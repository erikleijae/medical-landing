...
"[project]/src/app/es/login/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LoginPageEs() {
    ...
    const [isPasskeySubmitting, setIsPasskeySubmitting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const handleSubmit = async (event)=>{
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                email,
                password
            });
            if (error) {
            ...
            window.location.href = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolvePostLoginRedirectUrl"])();
        } catch (error) {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.social({
                provider: "google",
                callbackURL: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolvePostLoginRedirectUrl"])()
            });
        } catch (error) {
    ...
    const handlePasskeySignIn = async ()=>{
        ...
        setFormError(null);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.passkey({
                fetchOptions: {
                    onSuccess: ()=>{
                        window.location.href = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolvePostLoginRedirectUrl"])();
                    },
...
"[project]/src/app/es/login/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_d5d4e4._.js.map