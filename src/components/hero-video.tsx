        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-slate-100 shadow-[0_4px_24px_rgba(15,23,42,0.08)] transition-shadow duration-300 group-hover:shadow-[0_8px_40px_rgba(15,23,42,0.12)] group-hover:border-slate-300">
          <div className="relative aspect-[16/9] w-full">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div className="flex h-44 w-44 items-center justify-center rounded-full border-[4px] border-brand-accent-strong bg-white/90 shadow-[0_20px_60px_rgba(15,23,42,0.2),0_0_0_1px_rgba(0,0,0,0.05)] transition-all duration-300 group-hover:scale-105 group-hover:bg-white group-hover:shadow-[0_24px_72px_rgba(15,23,42,0.25)]">
