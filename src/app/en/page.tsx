...
export default function HomePageEn() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <article className="overflow-hidden rounded-3xl bg-white shadow-sm">
              ...
              <div className="px-5 pb-6 pt-4 text-sm text-slate-700">
                <p className="text-[13px] font-semibold text-slate-900">1. Start DeepClinic Copilot</p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-3xl px-6 py-32 text-center md:py-36">
          <p className="text-3xl font-medium leading-snug text-slate-900 sm:text-4xl">
            “Once you try DeepClinic Copilot, you don’t want to go back.”
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-32 md:py-36">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <figure className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 text-left text-sm text-slate-700 shadow-sm">
              ...
              <blockquote className="mt-3 space-y-2">
                <p className="text-sm text-slate-800">
                  &quot;Using DeepClinic Copilot is not about keeping up with the latest technology. It is, above all, about good
                  clinical practice. DeepClinic Copilot means I no longer spend 2 hours a day typing and only 15 minutes with
            ...
            <figure className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-white p-8 text-left text-sm text-slate-700 shadow-sm">
              ...
              <blockquote className="mt-3 space-y-2">
                <p>
                  &quot;While I examine the patient and have a natural conversation, DeepClinic Copilot transcribes and structures
            ...
            <figure className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-white p-6 text-left text-sm text-slate-700 shadow-sm">
              ...
              <blockquote className="mt-3 space-y-2">
                <p>
                  &quot;We have deployed DeepClinic Copilot across our clinics and are very happy with how it improves the dynamics
            ...
            <figure className="flex h-full flex-col justify-between rounded-3xl border border-slate-200 bg-white p-6 text-left text-sm text-slate-700 shadow-sm">
              ...
              <blockquote className="mt-3 space-y-2">
                <p>
                  ...
                  conversations, DeepClinic Copilot keeps the notes accurate and complete. I feel confident that nothing that
        ...
        <div className="mx-auto max-w-6xl px-6 py-32 md:py-36">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.1fr)] md:items-center">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl bg-slate-300">
              <Image
                src="/hipaa.png"
                alt="Security and compliance certifications of DeepClinic Copilot"
                fill
                className="object-cover"
      ...
      <section
        id="pricing"
        className="border-t border-slate-100 bg-gradient-to-b from-[#b7f453]/50 via-white to-white"
      >
        <div className="mx-auto max-w-6xl px-6 py-32 text-center md:py-36">
          <h2 className="font-display text-[32px] font-semibold leading-tight tracking-tight text-slate-900 sm:text-[36px]">
        ...
        <footer id="resources" className="border-t border-slate-100">
          <div className="mx-auto max-w-6xl px-6 py-10 text-xs text-slate-700 sm:text-[13px]">
            ...
            <p className="mt-4 text-center text-[11px] text-slate-400">
              © 2026 DeepClinic Copilot. All rights reserved.
            </p>
          </div>
        </footer>
      </section>
