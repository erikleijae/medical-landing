  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <h1 className="mt-3 text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">Terms of Service</h1>
        ...
        <section className="mt-8 space-y-3 text-sm leading-relaxed text-slate-700">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <span className="font-semibold">Service description:</span> The description of the content and scope of the
        ...
        <section className="mt-8 space-y-3 text-sm leading-relaxed text-slate-700">
          <h2 className="text-base font-semibold text-slate-900">4. Right to use the Service and account access</h2>
          <p>
