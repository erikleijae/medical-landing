        ...
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          ...
          <MotionReveal delayMs={100}>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">1. Definitions</h2>
              ...
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
                <li>
                  <span className="font-semibold text-white">User:</span> Any employee or contractor of the Customer who uses the
                  Service.
                </li>
                <li>
                  <span className="font-semibold text-white">Agreement:</span> The Agreement with the associated appendices and
                  supplements between the Customer and the Supplier, whereby the Supplier undertakes to provide the Service
                  to the Customer.
                </li>
                <li>
                  <span className="font-semibold text-white">Confidential information:</span> Information that is subject to
                ...
                <li>
                  <span className="font-semibold text-white">Service:</span> The services that the Supplier shall provide to the
                  Customer under the Agreement, which are further specified in the Service Description.
                </li>
                <li>
                  <span className="font-semibold text-white">Service description:</span> The description of the content and scope of the
                  Service that is an appendix to the Agreement, according to which the Provider shall provide the Service.
                </li>
                <li>
                  <span className="font-semibold text-white">The Secrecy Act:</span> The Act (2020:914) on Confidentiality in
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">2. Obligations of the Supplier</h2>
              <p>
            ...
            {/* 3. Acceptable use */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">3. Acceptable use</h2>
              <p>
              ...
              <p className="font-semibold text-white">User responsibilities:</p>
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
                <li>
                  <span className="font-semibold text-white">Review and edit notes:</span> Ensure all draft notes are reviewed,
                  corrected, and verified for accuracy before inclusion in patient records or Electronic Health Records (EHR).
                </li>
                <li>
                  <span className="font-semibold text-white">Professional judgment:</span> Rely on professional expertise when using
                  outputs from DeepClinic Copilot. The Service is a support tool, not a replacement for clinical
                  decision-making.
                </li>
                <li>
                  <span className="font-semibold text-white">Compliance:</span> Use DeepClinic Copilot in accordance with applicable
                  laws, regulations, and clinical standards in your jurisdiction.
                </li>
              </ul>
              <p className="font-semibold text-white mt-4">Prohibited actions:</p>
              <p>Users must not:</p>
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
              ...
              <p className="mt-4">Any violation of these terms may result in suspension or termination of access.</p>
            </section>

            {/* 4. Right to use the Service and account access */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">4. Right to use the Service and account access</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">5. Obligations of the Customer</h2>
              <p>
            ...
            {/* 6. Customer data */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">6. Customer data</h2>
              <p>
            ...
            {/* 7. Confidentiality */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">7. Confidentiality</h2>
              <p>
            ...
            {/* 8. Personal data */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">8. Personal data</h2>
              <p>
            ...
            {/* 9. Safety */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">9. Safety</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">10. Intellectual property rights</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">11. Development of the Service</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">12. Limitation of liability</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">13. Force majeure and changed conditions</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">14. Dispute resolution</h2>
              <p>
            ...
            <section className="mt-10 space-y-6 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">15. Payment and billing</h2>

              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.1 Plans and pricing</h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.2 Subscription and usage fees</h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.3 Taxes and other charges</h3>
                <p>
                  <span className="font-semibold text-white">15.3.1 General tax responsibility.</span> Unless otherwise stated, all Fees
                ...
                <p>
                  <span className="font-semibold text-white">15.3.2 Swedish customers.</span> DeepClinic Copilot AB is a Swedish company.
                ...
                <p>
                  <span className="font-semibold text-white">15.3.3 Customers in other regions.</span> For Customers located outside
                ...
                <p>
                  <span className="font-semibold text-white">15.3.4 Bank and conversion fees.</span> DeepClinic Copilot is not liable for
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.4 Accepted payment methods</h3>
                <p>
                  <span className="font-semibold text-white">15.4.1 Credit or debit card.</span> All Fees must be paid by a valid credit
                ...
                <p>
                  <span className="font-semibold text-white">15.4.2 Authorised charges.</span> By submitting card information, the
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.5 Changes to fees and payment terms</h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.6 Billing cycle and statements</h3>
                <p>
                  <span className="font-semibold text-white">15.6.1 Billing cycle.</span> Subscription Fees (if applicable) will be
                ...
                <p>
                  <span className="font-semibold text-white">15.6.2 Statements of charges.</span> DeepClinic Copilot will provide a
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.7 Late payments and non-payment</h3>
                <p>
                  <span className="font-semibold text-white">15.7.1 Payment failure.</span> If payment is declined or otherwise not
                  received on time, DeepClinic Copilot may charge interest on overdue amounts at the maximum rate permitted by
                  applicable law.
                </p>
                <p>
                  <span className="font-semibold text-white">15.7.2 Suspension or termination.</span> DeepClinic Copilot may suspend or
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.8 Refunds</h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-[16px] font-semibold text-white">15.9 Currency conversion</h3>
                <p>
