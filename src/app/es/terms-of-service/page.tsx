...
export default function TermsOfServicePage() {
  return (
    <main className="relative min-h-screen bg-[#1A1D23] text-white selection:bg-white/20">
      <GrokBackground />
      ...
      <section className="relative z-10 pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          ...
          <MotionReveal delayMs={100}>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              ...
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
                ...
                <li>
                  <span className="font-semibold text-white">Service description:</span> The description of the content and scope of
          ...
          <section className="mt-8 space-y-3 text-sm leading-relaxed text-white/70">
            <h2 className="text-base font-semibold text-white">5. Obligations of the Customer</h2>
