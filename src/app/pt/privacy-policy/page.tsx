        ...
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          ...
          <MotionReveal delayMs={100}>
            ...
            <section className="mt-12 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">1. Finalidade desta política de privacidade</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">2. Responsável pelo tratamento de dados</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">3. Ligações para sites de terceiros</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">4. Que dados pessoais recolhemos sobre si</h2>
              <p>
              ...
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
                <li>
                  <span className="font-semibold text-white">Dados de identificação:</span> por exemplo, nome e apelido, função
                ...
                <li>
                  <span className="font-semibold text-white">Dados de contacto:</span> como endereço de e‑mail e dados da sua
                  organização quando solicita contacto ou se candidata a um cargo através do Site.
                </li>
                <li>
                  <span className="font-semibold text-white">Dados técnicos:</span> incluindo informação sobre a sua utilização do Site,
                  como dados de tráfego, dados de comunicação e recursos acedidos, o que nos ajuda a melhorar o desempenho e a
                  segurança do Site.
                </li>
                <li>
                  <span className="font-semibold text-white">Dados de qualificação e percurso profissional:</span> por exemplo,
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">5. Como recolhemos os seus dados pessoais</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">6. Como utilizamos os seus dados pessoais</h2>
              <p>
              ...
              <ul className="list-disc space-y-2 pl-5 marker:text-white/40">
                <li>
                  <span className="font-semibold text-white">Com o seu consentimento:</span> quando nos dá uma autorização clara para
                  tratarmos os seus dados para um fim específico. Pode retirar o seu consentimento a qualquer momento.
                </li>
                <li>
                  <span className="font-semibold text-white">Interesse legítimo:</span> quando o tratamento é necessário para os nossos
                ...
                <li>
                  <span className="font-semibold text-white">Obrigação legal:</span> quando precisamos de tratar dados para cumprir uma
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">7. Conservação dos dados</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">8. Partilha dos seus dados pessoais</h2>
              <p>
            ...
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">9. Segurança dos dados</h2>
              <p>
            ...
            {/* 10. Os seus direitos */}
            <section className="mt-10 space-y-4 text-[15px] leading-relaxed text-white/70">
              <h2 className="text-[18px] font-bold text-white">10. Os seus direitos</h2>
              <p>
