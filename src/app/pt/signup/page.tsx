...
export default function SignupPagePt() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (signUpError) {
        setFormError(signUpError.message ?? "Não foi possível criar sua conta.");
        return;
      }
      ...
      if (signInResult?.error) {
        setFormError(signInResult.error.message ?? "Não foi possível entrar.");
        return;
      }
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setFormError(error instanceof Error ? error.message : "Não foi possível cadastrar com Google.");
    }
  };
          ...
          <div>
            ...
            <div className="mt-16 max-w-sm">
              ...
              <p className="mt-3 text-sm text-white/60">
                Informe seu nome, e-mail e senha para continuar no DeepClinic.
              </p>
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="relative flex items-center justify-center py-2">
                  ...
                  <span className="relative bg-black px-2 text-xs text-white/40">Ou</span>
                </div>
          ...
          <div className="relative flex h-full flex-col justify-end px-10 py-12 text-white">
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <div className="space-y-0.5 drop-shadow-sm">
                ...
                <p className="text-xs text-white/80">Profissional de saúde • Médica Sur</p>
              </div>
            </div>
          </div>
        </section>
