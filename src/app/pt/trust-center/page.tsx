...
export default function TrustCenterPagePt() {
  return (
    <main className="relative min-h-screen bg-black text-white selection:bg-white/20">
      ...
      <section className="relative z-10 pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          <MotionReveal>
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/40">Recursos</p>
            <h1 className="mt-6 font-sans text-[42px] font-bold leading-[0.95] tracking-tighter text-white sm:text-[56px]">
              Centro de confiança do DeepClinic Copilot
            </h1>
          </MotionReveal>

          <MotionReveal delayMs={100}>
            <p className="mt-8 text-[16px] leading-relaxed text-white/60">
              Este centro reúne a informação essencial sobre segurança, conformidade, privacidade e fiabilidade do serviço do
              DeepClinic Copilot. Aqui concentramos a referência atualizada para clientes e utilizadores.
            </p>
            <p className="mt-6 text-[16px] leading-relaxed text-white/60">
              Se precisar de documentação específica (avaliações de risco, acordos de tratamento de dados ou
              certificações), a nossa equipa pode fornecê‑la diretamente.
            </p>
          </MotionReveal>
